        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-white dark:bg-[var(--mongodb-navy)] text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[var(--mongodb-blue)]"
            >
