            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[var(--mongodb-dark-green)] focus:border-[var(--mongodb-dark-green)] dark:bg-[var(--mongodb-navy)] dark:text-white pr-10"
                  placeholder="••••••••"
                />
                <button
                  type="button"
